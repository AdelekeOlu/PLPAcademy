...
# we're using 'float()' to make sure our numbers can have decimals too. Fan num1 = float(input("Enter the first number:"))
...
#Add the two numbers from the first (Positive vibes only!) +
sum_result = num1 + num2

# Add the two numbers from the first (Negative vibes, but necessary!) -
